...
@click.option("-n", "node", default="examples/file_examples/node_file.txt", type=str,
              help="archivo con nodos que crean transacciones")
@click.option("-f", "file", default="examples/file_examples/transac_config.txt", type=str,
